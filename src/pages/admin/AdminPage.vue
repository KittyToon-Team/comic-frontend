    ...
    <aside class="sidebar">
      ...
      <div class="user-info" v-if="currentUser">
        ...
        <div class="user-text">
          ...
          <p class="username">{{ currentUser.displayName || currentUser.username }}</p>
        </div>
      </div>
      ...
      <nav class="menu">
        ...
        <router-link :to="{ name: 'AdminCategoryList' }">🏷️ Quản lý Thể loại</router-link>
      </nav>
...
.sidebar {
  width: 250px;
  /* Đổi từ màu xám xanh cũ sang nền hồng trắng dịu mắt */
